...
Welcome to my project portfolio! Below is a showcase of engineering and software projects I’ve built, ranging from **operating systems** and **embedded** to **robotics** and **mobile applications**.  
